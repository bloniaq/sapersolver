...
class Controller:
    ...
    def solve(self):
        ...
        while i_know_what_to_do:
            ...
            potential_mines, neighbours_of_mines \
                = self.model.get_potential_mines()
            self.reader.mark_multiple_mines(potential_mines)
    ...
    def _start_game(self):
        ...
        self.reader.discover_field(starting_field)
